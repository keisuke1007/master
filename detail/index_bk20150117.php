...
<div id="wrapper">
    ...
    <div id="breadcrumb">
        <ul>
            ...
            <li><a href="#"><? echo $row["job_category"] ?>の求人</a></li>
    ...
    <div class="job_company_tab clearfix">
        ...
        <div class="company_detail_tab"><a href="/detail/company.php?upd_key=<?php echo $row["id"]; ?>">企業詳細</a></div>
        <div class="entry_btn"><a href="job_app.php?upd_key=<?php echo $get_key;?>">応募フォームへ</a></div>
    </div>
        ...
        <div class="job_detail_wrapper">
            ...
            <div class="job_detail_txt_img_box clearfix">
                <div class="job_detail_img">
                    <img src="<?php echo $sub1_img; ?>" width="400" height="193" alt="">
                    <img src="<?php echo $sub2_img; ?>" width="400" height="193" alt="">
                </div>
...
完全週休2日制
            ...
            <div class="job_detail_entry_btn"><a href="/php/job_app.php?upd_key=<?php echo $get_key;?>">この求人の応募フォームへ</a></div>
