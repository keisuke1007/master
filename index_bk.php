...
<div id="wrapper">
    ...
    <div id="content" class="clearfix">
        ...
        <div id="con_right">
            <div class="btn_mr mb-20"><a href="#">新規会員登録(無料)</a></div>
            <div class="top_login mb-20">
                ...
                <div class="top_login_box">
                    <form accept-charset="UTF-8" action="" class="" id="" method="post">
                        <label for="user_mail">メールアドレス</label><input id="user_mail" class="mb-10" name="" size="30" type="text" placeholder="メールアドレス">
                        <label for="user_password">パスワード</label><input id="user_password" name="" size="30" type="password" placeholder="パスワード">
