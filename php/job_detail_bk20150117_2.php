...
$img1 = "admin/". $row["image1"];
$img2 = "admin/". $row["image2"];
$img3 = "admin/". $row["image3"];
...
<br>
  <table width="1000" border="0">
    ...
    <tr>
      ...
      <td><img src="<?php echo $img1; ?>" alt="image"  /></td>
    </tr>
    <tr>
      <th scope="row">サブ画像</th>
      <td><img src="<?php echo $img2; ?>" alt="image" /><br>
	      <img src="<?php echo $img3; ?>" alt="image" /></td>
    </tr>
    <tr>
