...
if($rtn==FALSE){ $err10 ="メールアドレスの書式が正しくありません。たとえば@が全角になっていませんか？";}
...
<? if($err1 != NULL || $err2 != NULL || $err3 != NULL|| $err4 != NULL|| $err5 != NULL|| $err6 != NULL|| $err7 != NULL|| $err8 != NULL || $err9 != NULL || $err10 != NULL) {
/*========エラー表示用=============================================*/
?>
<!-- 応募者登録フォーム -->
...
<table width="700" border="1" cellspacing="2" cellpadding="4">
  ...
  <tr>
    ...
    <td colspan="2"><? echo $err3; ?><? echo $err8; ?><? echo $err10; ?><input name="address1" type="text" id="address1" size="40" maxlength="40" value="<? echo $_POST["address1"] ?>"/></td>
  </tr>
  <tr>
