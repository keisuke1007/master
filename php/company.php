...
<div id="wrapper">
    ...
    <div id="breadcrumb">
        <ul>
            ...
            <li><a href="/php/job_detail.php?upd_key=<?php echo $row["id"]; ?>"><? echo $row["company_name"]?></a></li>
        </ul>
    </div>
    
    <div class="job_company_tab clearfix">
        <div class="job_detail_tab"><a href="/detail/index.php?upd_key=<?php echo $row["id"]; ?>">求人詳細</a></div>
